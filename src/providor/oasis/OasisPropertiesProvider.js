...
var elementTemplateDescriptionProps = require("bpmn-js-properties-panel/lib/provider/camunda/element-templates/parts/DescriptionProps"),
  ...
  getTemplateId = require("bpmn-js-properties-panel/lib/provider/camunda/element-templates/Helper")
    .getTemplateId;
...
function createElementTemplateGroups(
  ...
  elementTemplateInputParametersProps(
  ...
  elementTemplateOutputParametersProps(
...
//  */
function OasisPropertiesProvider(
  bpmnFactory,
  canvas,
  commandStack,
  elementRegistry,
...
OasisPropertiesProvider.$inject = [
  "bpmnFactory",
  "canvas",
  "commandStack",
  "elementRegistry",
...
inherits(OasisPropertiesProvider, PropertiesActivator);

module.exports = OasisPropertiesProvider;
